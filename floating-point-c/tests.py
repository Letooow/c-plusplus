...
def test_single_mul():
	...
	tester.add_easy(input = ["f", "0", "0x414587dd", "x", "0x42ebf110"], expected = "0x1.6c1b72p+10", name = "float (single): multiply (toward zero)",         categories = ["0", "single_multiply"])
	tester.add_easy(input = ["f", "1", "0x414587dd", "x", "0x42ebf110"], expected = "0x1.6c1b72p+10", name = "float (single): multiply (toward nearest even)", categories = ["1", "single_multiply"])
	tester.add_easy(input = ["f", "2", "0x414587dd", "x", "0x42ebf110"], expected = "0x1.6c1b74p+10", name = "float (single): multiply (toward pos infinity)", categories = ["2", "single_multiply"])
	tester.add_easy(input = ["f", "3", "0x414587dd", "x", "0x42ebf110"], expected = "0x1.6c1b72p+10", name = "float (single): multiply (toward neg infinity)", categories = ["3", "single_multiply"])
	return tester
...
def test_half_mul():
	...
	tester.add_easy(input = ["h", "0", "0x4145", "x", "0x42eb"], expected = "0x1.238p+3", name = "float (half): multiply (toward zero)",         categories = ["0", "half_multiply"])
	tester.add_easy(input = ["h", "1", "0x4145", "x", "0x42eb"], expected = "0x1.23cp+3", name = "float (half): multiply (toward nearest even)", categories = ["1", "half_multiply"])
	tester.add_easy(input = ["h", "2", "0x4145", "x", "0x42eb"], expected = "0x1.23cp+3", name = "float (half): multiply (toward pos infinity",  categories = ["2", "half_multiply"])
	tester.add_easy(input = ["h", "3", "0x4145", "x", "0x42eb"], expected = "0x1.238p+3", name = "float (half): multiply (toward neg infinity)", categories = ["3", "half_multiply"])
	return tester
